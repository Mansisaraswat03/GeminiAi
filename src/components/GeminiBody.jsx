...
const GeminiBody = ({ theme,submit,setInput,input,result,loading,displayResult,recentPrompts}) => {
  return (
    <div className="flex-1 min-h-[100vh] pb-[15vh] relative">
      ...
      {!displayResult ? (
        ...
        <div className=" fixed bottom-0 w-full max-w-[900px] px-5 m-auto">
          <form action={submit}>
          ...
          <p className="text-sm text-gray-400 text-center p-2 bg-bgPrimaryColor">Gemini may display inaccurate info, including about people, so double-check its responses. Your privacy & Gemini Apps</p>
        </div>
      </div>
    </div>
  );
