...
export default function Home() {
  ...
  return (
   <div className={`flex contain ${theme}`}>
    <Sidebar toggle={toggle} theme={theme} setDisplayResult={setDisplayResult} setInput={setInput} prevPrompts={prevPrompts} setRecentPrompts={setRecentPrompts} submit={submit}/>
    <GeminiBody theme={theme} submit={submit} setInput={setInput} input={input} result={result} loading={loading} displayResult={displayResult} recentPrompts={recentPrompts}  setPrevPrompts={setPrevPrompts} />
   </div>
  );
}
